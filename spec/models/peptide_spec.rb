...
describe '#parse_dataline' do
  it 'should write one record for a valid input line' do
    ...
    d1 = Dataline.new
    d1.tsv_string = str1
    Peptide.parse_dataline d1, 'carr'
